...
@synthesize viewController1,viewController2,rootController,navController,topMenu;
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSArray *tabs=[NSArray arrayWithObjects:viewController1,viewController2,topMenu,nil];
