...
-(void)getData:(int)number to:(NSString*)who
{
    ...
    [self RPCUseClass:@"Follow" callMethodName:@"getWantedFollowPage" withParameters:condition onCompletion:rentCompletionHandler];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.nameValue.text = [[_rentData[indexPath.row] objectForKey:@"wanted"] objectForKey:@"name"];
    cell.nameValue.font =[UIFont fontWithName:@"Helvetica" size:13];
    
    cell.phoneValue.text = [[_rentData[indexPath.row] objectForKey:@"wanted" ] objectForKey:@"phone"];
    ...
    NSString *surnameString= [[[_rentData[indexPath.row] objectForKey:@"wanted"] objectForKey:@"name"] substringToIndex:1];
