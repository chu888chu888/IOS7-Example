...
{
    UIView *detailView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 300, 250)];
    UIImageView *detailBgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 300, 250)];
    ...
    CSLinearLayoutView *realDetailView = [[CSLinearLayoutView alloc] initWithFrame:CGRectMake(0, 0, 300, 250)];
