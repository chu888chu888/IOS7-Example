...
-(void)getData:(int)number to:(NSString*)who
{
    ...
    [self RPCUseClass:@"Follow" callMethodName:@"getRentResourcesFollowPage" withParameters:condition onCompletion:rentCompletionHandler];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.nameValue.text = [[_rentData[indexPath.row] objectForKey:@"rentResources"] objectForKey:@"name"];
    cell.nameValue.font =[UIFont fontWithName:@"Helvetica" size:13];
    
    cell.phoneValue.text = [[_rentData[indexPath.row] objectForKey:@"rentResources"] objectForKey:@"phone"];
    ...
    NSString *houseType= [[[_rentData[indexPath.row] objectForKey:@"rentResources" ] objectForKey:@"house_type"] substringToIndex:1];
   if (![[[_rentData[indexPath.row] objectForKey:@"rentResources"] objectForKey:@"pic_url"] isEqualToString:@""]) {
