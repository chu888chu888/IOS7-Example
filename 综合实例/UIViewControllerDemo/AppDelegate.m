...
@synthesize viewController1,viewController2,viewController3,rootController,navController,topMenu;
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSArray *tabs=[NSArray arrayWithObjects:viewController1,viewController2,viewController3,navController,nil];
